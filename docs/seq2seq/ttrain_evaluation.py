...
class Seq2SeqTrainer:
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            with open(os.path.join(self.save_dir, f'Train_translations {epoch}.txt'), 'w+', encoding = 'utf-8') as f:
            ...
            with open(os.path.join(self.save_dir, f'Valid_translations {epoch}.txt'), 'w+', encoding = 'utf-8') as f:
                f.write(f'Epoch {epoch + 1} Translations:\n')
